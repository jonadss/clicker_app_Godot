...
func _process(delta: float) -> void:
	zahl_label.text = str(global.clicker_stand_01)
...
func apply_swipe(end_pos: Vector2):
	...
	if abs_x > abs_y and abs_x > swipe_threshold:
		...
		if delta_steps != 0:
			global.clicker_stand_01 += delta_steps * step_size  # umdrehen für natürliches Wischen
...
func on_swipe_left():
	...
	get_tree().change_scene_to_file("res://00_scene/01_main.tscn")

func on_swipe_right():
	print("👈 Szene nach links wechseln")   # z.B. vorherige Szene
	get_tree().change_scene_to_file("res://00_scene/-01_main.tscn")

# ----- Buttons -----
func _on_top_pressed() -> void:
	global.clicker_stand_01 += step_size
